...
public class RpiActivity extends AppCompatActivity {

    private ViewPager viewPager;
    private LinearLayout dotLayout;
    private SlideAdapterRpi myAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager = (ViewPager) findViewById(R.id.viewPagerRpi);
        myAdapter = new SlideAdapterRpi(this);
