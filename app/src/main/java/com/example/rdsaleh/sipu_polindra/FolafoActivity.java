...
public class FolafoActivity extends AppCompatActivity {

    private ViewPager viewPager;
    private LinearLayout dotLayout;
    private SlideAdapterFolafo myAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_folafo);

        viewPager = (ViewPager) findViewById(R.id.viewPagerFolafo);
        myAdapter = new SlideAdapterFolafo(this);
