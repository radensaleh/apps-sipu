...
public class KompaActivity extends AppCompatActivity {

    private ViewPager viewPager;
    private LinearLayout dotLayout;
    private SlideAdapterKompa myAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kompa);

        viewPager = (ViewPager) findViewById(R.id.viewPagerKompa);
        myAdapter = new SlideAdapterKompa(this);
