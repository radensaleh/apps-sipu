...
public class KopenActivity extends AppCompatActivity {

    private ViewPager viewPager;
    private LinearLayout dotLayout;
    private SlideAdapterKopen myAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kopen);

        viewPager = (ViewPager) findViewById(R.id.viewPagerKopen);
        myAdapter = new SlideAdapterKopen(this);
